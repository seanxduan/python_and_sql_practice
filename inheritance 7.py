...
class Square(Rectangle):
    def __init__(self, length):
        ...
        #so it means, pass these arguments (length) into the field in the original init method for the
        #parent class, ie length and width, but it's length x2 bc same size for squares!
        pass
