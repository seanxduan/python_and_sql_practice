def main():
    ...
    for dragon in dragons:
        describe(dragon)
    for dragon in dragons:
        dragon_copy = dragons.copy()
        dragon_copy.remove(dragon)
        dragon.breathe_fire(3,3,dragon_copy)

        #for tar_dragon in dragons.copy:
            #tar_dragon.breathe_fire(3,3,dragon_copy)
            #print(tar_dragon.name)
